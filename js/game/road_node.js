...
// RoadNode is a single point in 3D space used for connecting RoadRoutes.
    ...
    TRAFFICSIM_APP.game.road.RoadNode = function (worldController, position) {
    ...
    TRAFFICSIM_APP.game.road.RoadNode.prototype.getConnectedRoutes = function () {
        return this._connectedRoutes;
    };

    TRAFFICSIM_APP.game.road.RoadNode.prototype.getConnectedStartingRoutes = function () {
        var self = this;
    ...
    TRAFFICSIM_APP.game.road.RoadNode.prototype.getConnectedFreeStartingRoutes = function () {
        var self = this;
        return this._connectedRoutes.filter(function (route) {
    ...
    TRAFFICSIM_APP.game.road.RoadNode.prototype.addConnectedRoute = function (route) {
        this._connectedRoutes.push(route);
    };

    TRAFFICSIM_APP.game.road.RoadNode.prototype.removeConnectedRoute = function (route) {
